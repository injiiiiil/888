...
namespace OpenRA.Mods.Common.Traits
{
	...
	public interface ILinkClient
	{
		...
		void OnLinkCreated(Actor self, Actor hostActor, ILinkHost host);
		bool OnLinkTick(Actor self, Actor hostActor, ILinkHost dock);
		void OnLinkRemoved(Actor self, Actor hostActor, ILinkHost host);
		...
		/// </remarks>
		bool CanLink(BitSet<LinkType> type, bool forceEnter = false);
	...
	public interface ILinkHost
	{
		...
		/// </remarks>
		bool CanLink(Actor clientActor, ILinkClient client, bool ignoreReservations = false);
		bool Reserve(Actor self, LinkClientManager client);
		void UnreserveAll();
		void Unreserve(LinkClientManager client);
		void OnLinkCreated(Actor self, Actor clientActor, LinkClientManager client);
		void OnLinkRemoved(Actor self, Actor clientActor, LinkClientManager client);
		...
		bool QueueMoveActivity(Activity moveToLinkHostActivity, Actor self, Actor clientActor, LinkClientManager client, MoveCooldownHelper moveCooldownHelper);
