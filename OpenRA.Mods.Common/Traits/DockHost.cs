...
namespace OpenRA.Mods.Common.Traits
{
		...
		ILinkHost, ILinkHostDrag, ITick, INotifySold, INotifyCapture, INotifyOwnerChanged, ISync, INotifyKilled, INotifyActorDisposing
	{
		...
		public virtual bool CanLink(Actor clientActor, ILinkClient client, bool ignoreReservations = false)
		{
		...
		protected virtual void Tick(Actor self)
		{
			...
			if (linkedClientActor != null && (linkedClientActor.IsDead || !linkedClientActor.IsInWorld))
				OnLinkRemoved(self, linkedClientActor, linkedClient);
		}

		public virtual bool QueueMoveActivity(Activity moveToLinkHostActivity,
			Actor self, Actor clientActor, LinkClientManager client, MoveCooldownHelper moveCooldownHelper)
		{
