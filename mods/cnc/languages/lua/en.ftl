...
destroy-ion-cannon-advice = The GDI is preparing their Ion Cannon. Don't let them get comfortable using it.
...
air-strikes-intel-report = Nod airstrikes are being directed by a Communications Center to the northwest. We may gain useful information from capturing it.
capture-nod-communications-center = Capture the Nod Communications Center to the northwest.
communications-center-captured-sams-located = Our engineers have located Nod SAM sites and disarmed an unusual trap at the Construction Yard to the south.
