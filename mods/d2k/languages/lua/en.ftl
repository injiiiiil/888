...
contraband-not-confiscated = Smuggler contraband has arrived; confiscation failed.
...
ally-mercenaries = Persuade the Mercenaries to fight alongsid House Harkonnen.
...
ixian-reinforcements-in = The first batch of Ixian reinforcements arriving in { $time }
